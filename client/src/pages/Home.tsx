...
export default function Home() {
  const stats = [
    { label: "Total Assets", value: "$2.4B+", color: "text-primary" },
    { label: "Active Investors", value: "15,000+", color: "text-secondary" },
    { label: "Avg. Annual Return", value: "12.4%", color: "text-accent" },
    { label: "Properties", value: "850+", color: "text-purple-600" },
  ];
